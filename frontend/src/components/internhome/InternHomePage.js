...
class InternHome extends Component {
    render() {
        return (
                ...
                <div className="row p-1 m-3 ">
                    <div className="col-md-6 col-lg-4 my-1">
                        ...
                        <Link to="/help">
                            ...
                            <Link to="/help"><h5 className="card-titel text-capitalize text-info">get help</h5></Link>
                                <p className= "card-text"> Feel free to get help from people welling to help you.</p>
                               <Link to="/help" className="btn btn-outline-info text-uppercase" >
                    ...
                    <div className="col-md-6 col-lg-4 my-1">
                        ...
                        <Link to="/helprequest">
                            ...
                            <Link to="/helprequest"><h5 className="card-titel text-capitalize text-info">help others</h5></Link>
                                <p className= "card-text">Be a volunteer to Help people who are in need of help. </p>
                                <Link to="/helprequest" className="btn btn-outline-info text-uppercase" >
                                Click here to help
                                </Link>
                            </div>     
                        </div>
